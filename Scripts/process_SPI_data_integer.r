...
wd="D:/data/climate_data/2019_UH_clim_data/SPI_2021/spi_hawaii_250m/" 

#script will save all processed geotifs at the directory below
output_dir="D:/data/climate_data/2019_UH_clim_data/SPI_2021/spi_hawaii_250m_simple/"
...
sp_parallel_run=function(raster_list){
  ...
  for (raster_file in raster_list){
    ...
    img_int=round(img)
    #plot(img)
    writeRaster(img_int, filename = output_file_name, compress="LZW", overwrite=T, format="GTiff", datatype="INT2S")
  }
